...
- Engenharia de atributos para criar novas variáveis úteis
...
├── analise-de-vendas-ecommerce.ipynb   # Análise principal dos dados
├── gerando_dados_ficticios.ipynb       # Script para gerar dados fictícios
...
- **Distribuição de vendas por estado** - Compreensão da performance regional
...
1. **Bibliotecas** - Importação de dependências
2. **Carregando e Explorando os dados** - Carregamento e análise inicial
3. **Limpeza, Pré-Processamento e Engenharia de Atributos** - Transformação dos dados
4. **Análise 1: Top 10 produtos mais vendidos**
5. **Análise 2: Faturamento mensal**
6. **Análise 3: Distribuição de vendas por estado**
